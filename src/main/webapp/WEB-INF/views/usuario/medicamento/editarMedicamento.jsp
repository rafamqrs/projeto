...
<tiles:insertDefinition name="defaultTemplate">
	<tiles:putAttribute name="body">
		...
		<div id="cadastro" class="tab-pane fade active in">
			...
			<form:form method="POST" commandName="medicamento"
				action="${pageContext.request.contextPath}/medicamento/editar/${medicamento.idMedicamento}.html">
				<div class="col-lg-6">
					<!-- Campo nome empregado -->
					<div class="form-group">
						<label for="idMedicamento"><spring:message
								code="label.idMedicamento" /></label>
						<div class="input-group">
							<form:input path="idMedicamento" cssClass="form-control"
